...
function getCoverageHealth(coveragePercentage) {
  ...
  if (pct >= 25) {
    return {
      ...
      description: 'Low coverage (<50%). High ratio of skipped or blocked routes. Audit findings carry moderate certainty.'
    };
  }
  ...
  return {
    ...
    description: 'Critical coverage deficit (<25%). Speculative revenue and contract values have been suppressed to protect agency credibility.'
  };
}
