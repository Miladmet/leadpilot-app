...
const POSTGRES_SELF_HEAL_STATEMENTS = [
  ...
  `ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "analysesLimit" INTEGER DEFAULT 10;`,
  `ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "analysesUsed" INTEGER DEFAULT 0;`,
  `ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "resetDate" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP;`
];
