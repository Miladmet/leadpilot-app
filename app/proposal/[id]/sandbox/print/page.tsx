  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 p-8 max-w-4xl mx-auto print:p-0 relative">
      ...
      <div className="min-h-[1000px] flex flex-col justify-between border-b-8 border-slate-900 pb-12 mb-12 page-break-after">
        <div className="pt-20">
          <span className="text-xs font-bold tracking-widest text-sky-600 uppercase">LEADPILOT SOFTWARE • SOLUTION SANDBOX</span>
        ...
        <div className="pt-12 space-y-6">
          ...
          <div className="p-4 bg-amber-50/80 border border-amber-200 rounded-xl text-xs text-amber-900 leading-relaxed">
            <strong>Sandbox Planning Notice:</strong> Evidence-backed opportunity analysis and solution recommendations designed to help agencies win more clients.
          </div>
        </div>
      </div>
      ...
      <header className="border-b-4 border-slate-900 pb-6 mb-8 flex justify-between items-end">
        <div>
          ...
          <h2 className="text-3xl font-black text-slate-900 uppercase mt-0.5">{prospect.companyName}</h2>
          ...
          <span className="text-xs text-slate-400 font-mono block mt-1">{prospect.websiteUrl}</span>
        </div>
      ...
      <footer className="mt-12 text-xs text-slate-400 border-t border-slate-200 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="text-left">
          ...
          <p className="text-[10px] text-slate-400/80">Generated by LeadPilot Software Safe Verification Platform • Confidential Solution Sandbox Preview</p>
        </div>
