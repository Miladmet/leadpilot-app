  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 p-8 max-w-4xl mx-auto print:p-0 relative">
      ...
      <div className="min-h-[1000px] flex flex-col justify-between border-b-8 border-slate-900 pb-12 mb-12 page-break-after">
        <div className="pt-24">
          <span className="text-xs font-bold tracking-widest text-sky-600 uppercase">LEADPILOT AI • CLIENT ACQUISITION SUITE</span>
        ...
        <div className="pt-12 space-y-6">
          <div className="grid grid-cols-2 gap-6 text-xs">
            ...
            <div>
              ...
              <strong className="text-slate-800 text-base block mt-1">Generated by LeadPilot AI</strong>
      ...
      <header className="border-b-4 border-slate-900 pb-6 mb-6 flex justify-between items-end">
        <div>
          <span className="text-xs font-bold text-sky-600 uppercase tracking-wider block">Generated by LeadPilot AI</span>
        ...
        <div className="text-right">
          <p className="text-sm font-bold text-slate-900">Generated by LeadPilot AI</p>
